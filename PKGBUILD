...
source=("grub::git+https://git.savannah.gnu.org/git/grub.git#commit=$_GRUB_COMMIT"
        ...
        'grub-salientos-modifications-2.patch'
...
sha256sums=('SKIP'
            ...
            '10b97b2fc2915d578e460464bd6c9e61bc24d59aea50b48daff1c8c9f61e0f8a'
            ...
            '44ce0fd52da1a6ef4632e938de1029341f0d9061b7910e8a8c9cb5bc48ed2dd2'
...
prepare() {
	...
	echo "===> Patch to include Salient OS Modifications"
	patch -Np1 -i "${srcdir}/grub-salientos-modifications.patch"
	patch -Np1 -i "${srcdir}/grub-salientos-modifications-2.patch"
	...
	echo "Bump Version to ${pkgver}~${pkgrel}~salientos"
	sed -i -e "s|${_GRUB_INT_VER}|${pkgver}~${pkgrel}~salientos|g" "configure.ac"
